...
describe ControlledAccess::Configuration do
  describe '.authorization_adapter' do
    it 'should return default value' do
      expect(ControlledAccess::Configuration.authorization_adapter).to be == :pundit
    end
    
    it 'should accept new value' do
      ControlledAccess::Configuration.authorization_adapter = :cancan
      
      expect(ControlledAccess::Configuration.authorization_adapter).to be == :cancan
    end
  end
  
  describe '.auto_authorisation' do
    it 'should return default value' do
      expect(ControlledAccess::Configuration.auto_authorisation).to be_falsey
    end
    
    it 'should accept new value' do
      ControlledAccess::Configuration.auto_authorisation = :cancan
      
      expect(ControlledAccess::Configuration.auto_authorisation).to be == :cancan
    end
  end
